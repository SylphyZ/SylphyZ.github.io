...
![Figure 10.1 Martingale低波动策略累计收益](images/ch10/fig10_1_low_vol_cumulated_returns.jpg)
...
Alpha = 0.72%/月，年化8.6%，$t = 2.02 > 2$，在95%置信水平下显著。这个Alpha叫做**Jensen's alpha**，源自Michael Jensen 1968年的开创性研究。Beta = 0.51意味着Buffett的市场风险只有市场的一半。隐含复制组合为0.49份T-bills + 0.51份市场组合。Adj $R^2 = 14\%$ 对单只股票来说已经较高（大多数低于10%）。
...
![Figure 10.2 Berkshire Hathaway累计超额收益](images/ch10/fig10_2_brk_cumulative_excess_returns.jpg)
...
![Figure 10.3 CalPERS累计超额收益](images/ch10/fig10_3_calpers_cumulated_excess_returns.jpg)
...
![Figure 10.4 NCREIF累计超额收益](images/ch10/fig10_4_ncreif_cumulative_excess_returns.jpg)
...
![Figure 10.5 风格分析（不做空）](images/ch10/fig10_5_style_analysis_no_short.jpg)
...
![Figure 10.6 风格分析（允许做空）](images/ch10/fig10_6_style_analysis_with_short.jpg)
...
![Figure 10.7 卖看跌期权的伪Alpha](images/ch10/fig10_7_capm_regression_alpha_illusion.jpg)
...
Alpha基于基准，基准基于因子模型。测试Alpha是否为零，等价于测试市场效率——学术上叫**联合假设问题（Joint Hypothesis Problem）**：你同时在检验"管理人有没有技能"和"你的风险模型对不对"。
...
![Figure 10.8 波动率分组组合](images/ch10/fig10_8_volatility_portfolios.jpg)
...
![Figure 10.9 同期波动率与收益](images/ch10/fig10_9_contemporaneous_volatility.jpg)
...
![Figure 10.10 Beta分组组合](images/ch10/fig10_10_beta_portfolios.jpg)
...
![Figure 10.11 同期Beta与收益](images/ch10/fig10_11_contemporaneous_beta.jpg)
...
![Figure 10.12 BAB因子的构造逻辑](images/ch10/fig10_12_bab_factor_diagram.jpg)
...
![Figure 10.13 BAB与VOL因子累计收益](images/ch10/fig10_13_bab_vol_cumulated_returns.jpg)
...
![Figure 10.14 代理问题与低风险异象](images/ch10/fig10_14_agency_problems.jpg)
